    ...
    <header className="w-full border-b border-violet-100/80 bg-white/80 backdrop-blur-md sticky top-0 z-50 shadow-sm shadow-violet-100/30">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 sm:h-20 flex items-center justify-between gap-3">
        ...
        <Link href="/" className="flex items-center gap-2.5 sm:gap-3.5 group shrink-0">
          <div className="relative flex items-center justify-center p-2 sm:p-2.5 rounded-xl bg-slate-900 text-white transition-all duration-300 group-hover:bg-violet-600 group-hover:scale-105 group-hover:shadow-lg group-hover:shadow-violet-200">
            <svg className="w-6 h-6 sm:w-7 sm:h-7" viewBox="0 0 100 80" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                ...
                fill="currentColor"
              />
              <path d="M42 56H58L62 66H38L42 56Z M32 66H68V71H32V66Z" fill="currentColor" />
              <g className="transition-transform duration-500 ease-out group-hover:translate-x-1 group-hover:-translate-y-0.5">
                ...
                />
                <path d="M32 41L90 19V25L42 41H32Z" fill="currentColor" />
                <path
          ...
          <div className="flex flex-col">
            <span className="text-lg sm:text-xl font-extrabold tracking-wide text-slate-900 leading-none whitespace-nowrap">
              SIMON <span className="text-violet-600 group-hover:text-violet-700 transition-colors">BOSSELER</span>
            </span>
            <span className="text-[7px] sm:text-[9px] tracking-widest text-slate-500 uppercase font-extrabold mt-1">
        ...
        {/* Boutons de droite, desktop uniquement */}
        ...
        {/* Menu mobile */}
        <MobileMenu navLinks={navLinks} isLoggedIn={!!user} logoutAction={logout} />
      </div>
    </header>
  );
}